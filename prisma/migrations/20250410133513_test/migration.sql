...
CREATE TABLE `Productivity` (
    ...
    `AIactions` JSON NOT NULL,
    `GUIactions` JSON NOT NULL,

    UNIQUE INDEX `Productivity_prodId_key`(`prodId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `Trip` (
    `tripId` VARCHAR(191) NOT NULL,
    `tripName` VARCHAR(191) NOT NULL DEFAULT 'Untitled',
    ...
    `historyString` LONGTEXT NOT NULL,
    `changed` BOOLEAN NOT NULL DEFAULT false,

    UNIQUE INDEX `Trip_tripId_key`(`tripId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Plan` (
    ...
    `colour` VARCHAR(191) NOT NULL DEFAULT 'blue',
